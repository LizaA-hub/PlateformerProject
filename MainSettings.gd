...
func _on_pressed():
	if IsOpen:
		...
		IsOpen = false
		texture_normal = load("res://sunny-land-phaser-project/sunny-land/assets/sprites/SettingIcon.tga")
		Utils.saveSettings()
	else:
		get_node("AnimationPlayer").play_backwards("Transition")
		IsOpen =true
		texture_normal = load("res://sunny-land-phaser-project/sunny-land/assets/sprites/SettingIconPressed.tga")
...
func _on_h_slider_value_changed(value):
	...
	#print(ToDB(value))
	if value == 0:
		get_node("Panel/Volume/SoundIcon").texture = load("res://sunny-land-phaser-project/sunny-land/assets/sprites/SoundOff.tga")
	elif value >0 && value <=0.5:
		get_node("Panel/Volume/SoundIcon").texture = load("res://sunny-land-phaser-project/sunny-land/assets/sprites/SoundMin.tga")
	elif value >0.5 && value <1:
		get_node("Panel/Volume/SoundIcon").texture = load("res://sunny-land-phaser-project/sunny-land/assets/sprites/SoundPlus.tga")
	else:
		get_node("Panel/Volume/SoundIcon").texture = load("res://sunny-land-phaser-project/sunny-land/assets/sprites/SoundMax.tga")
